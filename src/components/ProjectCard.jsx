    ...
    <div className="bg-[#222222] shadow-xl rounded-md flex flex-col">
      ...
      <div className="p-5 flex flex-col flex-grow space-y-3 text-center">
        ...
        <button
          ...
          className="bg-crimson border-2 border-crimson text-white px-4 py-2 rounded-md font-medium hover:bg-transparent transition-all duration-200 ease-in-out active:scale-95 mt-auto"
        >
          View Details
        </button>
      </div>
