        ...
        <div className="flex flex-col-reverse sm:flex-row md:items-center">
          ...
          <div className="basis-1/2 text-white space-y-5 text-center sm:text-left">
            <div className="space-y-1 md:space-y-3">
              ...
              <h3 className="text-xl md:text-3xl flex justify-center sm:justify-start gap-2">
                And I'm a
            ...
            <div className="flex gap-5 justify-center sm:justify-start">
              <Link
                to="https://www.facebook.com/gulam.jakaria.732339/"
                target="_blank"
              >
              ...
              <Link
                to="https://www.linkedin.com/in/gulam-jakaria-4a5086311/"
                target="_blank"
              >
