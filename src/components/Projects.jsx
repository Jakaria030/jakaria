                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                        <div className="bg-[#222222] shadow-xl rounded-md flex flex-col">
                            ...
                            <div className="p-5 flex flex-col flex-grow space-y-3 text-center">
                                ...
                                <p className="font-poppins text-justify flex-grow">Sea Haven is a web-based hotel booking platform designed to provide users with an effortless way to find and book their dream stay near the sea. The platform showcases a curated list of seaside hotels, offers detailed room information, and enables smooth online bookings. This project demonstrates innovative solutions for managing hotel reservations with a focus on user experience.</p>
                                <button className="bg-crimson border-2 border-crimson text-white px-4 py-2 rounded-md font-medium hover:bg-transparent transition-all duration-200 ease-in-out active:scale-95 mt-auto">View Details</button>
                            </div>
                        </div>
                        ...
                        <div className="bg-[#222222] shadow-xl rounded-md flex flex-col">
                            ...
                            <div className="p-5 flex flex-col flex-grow space-y-3 text-center">
                                ...
                                <p className="font-poppins text-justify flex-grow">MSA School is an educational platform designed to facilitate learning and provide easy access to resources for students. The platform offers a user-friendly interface where students can manage their profiles, view courses, track progress, and engage with educational content effectively.</p>
                                <button className="bg-crimson border-2 border-crimson text-white px-4 py-2 rounded-md font-medium hover:bg-transparent transition-all duration-200 ease-in-out active:scale-95 mt-auto">View Details</button>
                            </div>
                        </div>
                        ...
                        <div className="bg-[#222222] shadow-xl rounded-md flex flex-col">
                            ...
                            <div className="p-5 flex flex-col flex-grow space-y-3 text-center">
                                ...
                                <p className="font-poppins text-justify flex-grow">Visa Care is a web-based platform designed to streamline the visa application process, making it easy for users to check visa requirements and add visa details. This system offers a user-friendly interface to simplify complex visa procedures. The project demonstrates practical solutions for managing visa-related information efficiently.</p>
                                <button className="bg-crimson border-2 border-crimson text-white px-4 py-2 rounded-md font-medium hover:bg-transparent transition-all duration-200 ease-in-out active:scale-95 mt-auto">View Details</button>
                            </div>
                        </div>
                    </div>
